...
This code is from lab 7, question 8. *I added a function stop to check if the input was a data frame. If the input is not a data frame, the function stops and returns an error message. I also added a function stop that checks if the columns are in the given data frame and if they are not, the function stops and returns an error message. This is important because it ensures that the input is the correct type, preventing errors.*
...
Each week, I completed peer reviews, offering feedback on the tidiness and efficiency of my peers' code. I made sure to acknowledge their strengths and provided constructive suggestions in a respectful manner, focusing on ways they could improve the organization and performance of their code.
