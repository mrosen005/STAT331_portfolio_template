...
I have demonstrated this learning target throughout my lab assignments this qarter. Firstly, in the YAML of my quarto documents, I have incorporated various features to my rendered document such as code-folding and embedding resources, making my quarto documents look professional. Secondly, I have been conscientious of making my code tidy, adhering to the tidyverse style guidelines, using named arguments, and starting new lines after commas, plus signs, and pipe operators. I have also been conscientious of making my code efficient, specifically using one function to perform multiple operations. Lastly, I have learned how to use and have implemented the here function into my projects to load in data.
...
# This code is from lab 9, question 3
...
# This code is from lab 9, question 8
...
# This code is from lab 9, question 7.
